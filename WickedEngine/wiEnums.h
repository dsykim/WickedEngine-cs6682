...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		//IsaacShaderTag1
		CSTYPE_POSTPROCESS_PIXELSHADER,
		CSTYPE_POSTPROCESS_TOONSHADER,
		CSTYPE_POSTPROCESS_KUWAHARASHADER,
		CSTYPE_POSTPROCESS_CRT,
		CSTYPE_POSTPROCESS_TONEMAP,
		CSTYPE_POSTPROCESS_UNDERWATER,
		CSTYPE_POSTPROCESS_MESH_BLEND_PREPARE,
		CSTYPE_POSTPROCESS_MESH_BLEND_EXPAND,
		...
		CSTYPE_WIND,
		CSTYPE_YUV_TO_RGB,
		CSTYPE_YUV_TO_RGB_ARRAY,
		CSTYPE_WETMAP_UPDATE,
		CSTYPE_CAUSTICS,
		CSTYPE_DEPTH_REPROJECT,
		CSTYPE_DEPTH_PYRAMID,
		CSTYPE_LIGHTMAP_EXPAND,
		...
		MSTYPE_OBJECT,
		MSTYPE_OBJECT_PREPASS,
		MSTYPE_OBJECT_PREPASS_ALPHATEST,
		MSTYPE_OBJECT_SIMPLE,
		MSTYPE_SHADOW,
		MSTYPE_SHADOW_ALPHATEST,
		MSTYPE_SHADOW_TRANSPARENT,
